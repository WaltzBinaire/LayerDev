...
{    
    ...
    static shared_ptr<AutoShader> get_collage_overlay_shader(){ return get_shader("shaders/vert.vert"          , "shaders/collage_overlay.frag"      ); };
    ...
    static shared_ptr<AutoShader> get_uv_overlay_shader()     { return get_shader("shaders/vert.vert"          , "shaders/uv_overlay.frag"              ); };
    ...
    static shared_ptr<AutoShader> get_histogram_shader()      { return get_shader("shaders/histogram_vert.vert", "shaders/histogram_frag.frag"       ); };
    static shared_ptr<AutoShader> get_postprocessing_shader() { return get_shader("shaders/histogram_vert.vert", "shaders/postprocessing.frag"       ); };
